...
export const EDUCATION = [
  {
    year: "2022 - 2025",
    college: "Anil Neerukonda Institute of Technology & Science -BTech in CSE(AL&ML) ",
    cgpa: "CGPA-80%",
    Location: `Near Three Temples Bheemunipatnam, Sanghivalasa, Visakhapatnam, Andhra Pradesh 531162 `,
    technologies: ["Bachelor of Technology"],
  },
  {
    year: "2019 - 2022",
  ...
  {
    year: "2018-2019 ",
    college: "PRASANTHINIKETAN M.V.V.S MURTHY ENGLISH MEDIUM HIGH SCHOOL",
    cgpa: "GPA: 9.5/10",
    Location: `ANAKAPALLI,VISAKHAPATNAM`,
    technologies: ["SCC"],
  },
];
...
export const CONTACT = {
  address: " DNO:16-1-4/3 GAVARAPALEM,ANAKAPALLI,VISAKHAPATNAM-530016",
  phoneNo: "7989927752 ",
  email: "kaicharlalalithkumar@gmail.com",
};
